...
void defaultSigTstpHandler(void) // task mySIGINT handler
{
    printf("\ndefaultSigTstpHandler");
    return;
}

void defaultSigTermHandler(void) // task mySIGINT handler
{
    printf("\ndefaultSigKillpHandler");
    return;
}
...
void createTaskSigHandlers(int tid)
{
    ...
    if (tid)
    {
        ...
        tcb[tid].sigTermHandler = tcb[curTask].sigTermHandler; // mySIGKILL handler
    ...
    else
    {
        ...
        tcb[tid].sigKillHandler = defaultSigTermHandler; // task mySIGKILL handler
