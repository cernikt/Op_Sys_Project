// os345p4.c - Virtual Memory	06/21/2020
//
...
//
//
int P4_main(int argc, char *argv[]) // project 5
{
...
int P4_vmaccess(int argc, char *argv[])
{
    ...
    printf("\nclockRPT = %d, clockUPT = %d, Pages = %d", clockRPT, clockUPT, accessPage(0, 0, PAGE_GET_SIZE));
    return 0;
} // end P4_vmaccess
...
int P4_initMemory(int argc, char *argv[])
{
    ...
    printf("\nPhysical Address Space = %d frames (%0.1fkb)", (highAdr >> 6) - LC3_MEM_FRAME,
           ((highAdr >> 6) - LC3_MEM_FRAME) / 8.0);
